...
//           // Ensure batch is defined
//           if (batch === undefined) {
//             // Handle undefined case, e.g., by skipping or assigning to a default key
//             return acc; // Skip candidates with undefined batch
//             // Or, you could assign to a default batch if needed:
//             // acc['default'] = acc['default'] || [];
//             // acc['default'].push(candidate);
//           }
        
//           // Check if acc[batch] is an array
//           if (!Array.isArray(acc[batch])) {
//             acc[batch] = [];
//           }
