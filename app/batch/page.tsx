...
//   const handleAddRow = () =>
//     setModalState({ add: true, edit: false, view: false });
...
//       if (selectedRows.length > 0) {
//         setSelectedRow(selectedRows[0]);
//         setModalState({ add: false, edit: true, view: false });
//       } else {
//         alert("Please select a row to edit.");
//       }
//     }
...
//       if (selectedRows.length > 0) {
//         setSelectedRow(selectedRows[0]);
//         setModalState({ add: false, edit: false, view: true });
//       } else {
//         alert("Please select a row to view.");
//       }
//     }
...
//   return (
//     <div className="p-4 mt-20 mb-10 ml-20 mr-20 bg-gray-100 rounded-lg shadow-md relative">
//       {/* Modal Pop-ups for Add, Edit, and View */}
//       {modalState.add && (
//         <AddRowModal
//           isOpen={modalState.add}
//           onClose={() =>
//             setModalState((prevState) => ({ ...prevState, add: false }))
//           }
//         />
//       )}
//       {modalState.edit && selectedRow && (
...
//           isOpen={modalState.view}
//           onClose={() =>
//             setModalState((prevState) => ({ ...prevState, view: false }))
//           }
//           rowData={selectedRow}
//         />
//       )}
...
//           <button
//             onClick={handleDownloadPDF}
//             className="flex items-center px-4 py-2 bg-indigo-600 text-white rounded-md transition duration-300 hover:bg-indigo-700"
//           >
//             <FaDownload className="mr-2" /> Download PDF
//           </button>
//         </div>
...
//             pagination={true}
//             onPageChanged={(event) =>
//               handlePageChange(event.api.paginationGetCurrentPage())
//             }
...
//     const pdfData = rowData.map((row) => Object.values(row));
//     doc.autoTable({
//       head: columnDefs.map(col => col.headerName), // Use dynamic headers
//       body: pdfData,
//     });
