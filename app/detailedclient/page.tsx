...
// import type { DetailedClient } from "@/types";  // Ensure it's imported as a type
...
//         // const dataWithSerials = data.map((item: Client , index: number) => ({
//         //     ...item,
...
//           ...item,
//           serialNo: (currentPage - 1) * paginationPageSize + index + 1,
//           name: item.companyName || "Unnamed", // You can decide on the default value or mapping logic for 'name'
...
// app/detailedclient/page.tsx

import React from 'react';

const DetailedClientPage = () => {
  return (
    <div>
      <h1>Detailed Client Page</h1>
    </div>
  );
};
