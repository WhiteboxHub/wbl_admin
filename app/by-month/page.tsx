...
const ByMonth = () => {
  ...
  const setupColumns = (data: ByMonth[]) => {
    if (data.length > 0) {
      const columns = [
    ...
    <div className="p-4 mt-20 mb-10 ml-20 mr-20 bg-gray-100 rounded-lg shadow-md relative">
      <div className="flex justify-between items-center mb-4">
        ...
        <div className="flex space-x-2">
          ...
          >
            <MdAdd className="mr-2" /> Add By Month
          </button>
          <button
...
//       const selectedRows = gridRef.current.api.getSelectedRows();
//       if (selectedRows.length > 0) {
//         const byMonthId = selectedRows[0].id;
//         if (byMonthId) {
//           const confirmation = window.confirm(
//             `Are you sure you want to delete PO ID ${byMonthId}?`
//           );
//           if (!confirmation) return;
...
//     const subGridData = params.data.subGridData || [];
//     return (
//       <div className="ag-details-grid">
//         <AgGridReact
//           columnDefs={[
//             { headerName: "Subgrid Column 1", field: "subgridCol1" },
//             { headerName: "Subgrid Column 2", field: "subgridCol2" },
//           ]}
//           rowData={subGridData}
...
//             pagination={false}
//             domLayout="normal"
//             rowSelection="multiple" // Updated row selection configuration
//             masterDetail={true}
