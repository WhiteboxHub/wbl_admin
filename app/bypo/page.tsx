...
import AddRowModal from "../../modals/AddRowByPO";
import EditRowModal from "../../modals/EditRowByPO";
import ViewRowModal from "../../modals/ViewRowByPO";
...
const ByPO = () => {
  ...
  const fetchData = async () => {
    setLoading(true);
    try {
      const response = await axios.get(`${API_URL}/by-po`, {
        params: {
          page: currentPage,
  ...
  const fetchByPOs = async (searchQuery = "") => {
    try {
      const response = await axios.get(`${API_URL}/by-po/search`, {
        params: {
          page: currentPage,
          pageSize: paginationPageSize,
          search: searchQuery,
    ...
    <div className="p-4 mt-20 mb-10 ml-20 mr-20 bg-gray-100 rounded-lg shadow-md relative">
      <div className="flex justify-between items-center mb-4">
        ...
        <div className="flex space-x-2">
          ...
          >
            <MdAdd className="mr-2" /> Add By PO
          </button>
          <button
