  ...
  return (
    <div className="min-h-screen relative z-10 overflow-hidden pt-24 pb-16 flex flex-col items-center justify-center bg-gray-100">
      <div className="bg-gray-300 p-8 rounded-lg shadow-lg text-center max-w-lg w-full">
        <h1 className="text-3xl font-bold text-gray-800 mb-6">Welcome to Admin Page</h1>
      ...
      <div className="absolute bottom-0 left-0 z-[-1] opacity-30 lg:opacity-100">
        ...
        >
          ...
          />
          <path
            d="M-98.1618 65.0889C-68.1416 60.0601 4.73364 60.4882 56.0734 102.431C120.248 154.86 139.336 160.972 177.353 166.104C215.37 171.237 257.447 185.808 285.161 216.583"
